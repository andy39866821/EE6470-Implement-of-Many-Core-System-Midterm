                ...
                for(int i = 0 ; i < 2 ; i++){
                    for (int j = 0 ; j < 2 ; j++){
                        ...
                        for (int c = 0; c != 3; c++) {
                            for (int r = 0; r != 5; r++) {
                                for(int s = 0; s != 5 ; s++) {
                                    o_conv1_input.put(input_quantized[c][p + r][q + s]);
...
void Testbench::conv1_fetch_result(){
    ...
    for (int m = 0; m != 6; m++) {
        for (int p = 0; p != 14; p++) {
            for(int q = 0; q != 14 ; q++) {
			    conv1_activation[m][p][q] = i_conv1_activation.get();
               // cout << "Get data: " << result << endl;
                if(conv1_activation[m][p][q] != conv1_activation_golden[m][p][q]){
                    
                    cout << "ERROR: m" << " " << p << " " << q << " :" <<  conv1_activation[m][p][q] 
                         << "\n   Correct should be: " << conv1_activation_golden[m][p][q] << endl;
                    pass = false;
                }
                conv1_activation_quantized[m][p][q] = round(((double)conv1_activation[m][p][q] / conv1_output_scale));
                ...
                for(int i = 0 ; i < 2 ; i++){
                    for (int j = 0 ; j < 2 ; j++){
                        ...
                        for (int c = 0; c != 6; c++) {
                            for (int r = 0; r != 5; r++) {
                                for(int s = 0; s != 5 ; s++) {
                                    o_conv2_input.put(conv1_activation_quantized[c][p + r][q + s]);
...
void Testbench::conv2_fetch_result(){
    ...
    for (int m = 0; m != 16; m++) {
        for (int p = 0; p != 5; p++) {
            for(int q = 0; q != 5 ; q++) {
			    conv2_activation[m][p][q] = i_conv2_activation.get();
               // cout << "Get data: " << result << endl;
                if(conv2_activation[m][p][q] != conv2_activation_golden[m][p][q]){
                    
                    cout << "ERROR: m" << " " << p << " " << q << " :" <<  conv2_activation[m][p][q] 
                         << "\n   Correct should be: " << conv2_activation_golden[m][p][q] << endl;
                    pass = false;
                }
                fc1_input[cnt++] = round(((double)conv2_activation[m][p][q] / conv2_output_scale));
...
void Testbench::fc1_feed_input(){
    ...
    for (int m = 0; m != FC1_M; m++) {
        ...
        fc1_each_row_start_time = sc_time_stamp();                        
    }
...
void Testbench::fc1_fetch_result(){
    ...
    for (int m = 0; m != FC2_H; m++) {
        ...
        if(has_show_each_row_time == false){
            has_show_each_row_time = true;
            cout << "   FC1 each row simulated time: " << sc_time_stamp() - fc1_each_row_start_time << endl;
        }
    }
...
void Testbench::fc2_feed_input(){
    ...
    for (int m = 0; m != FC2_M; m++) {
        ...
        fc2_each_row_start_time = sc_time_stamp();                      
    }
...
void Testbench::fc2_fetch_result(){
    ...
    for (int m = 0; m != FC3_H; m++) {
        ...
        if(has_show_each_row_time == false){
            has_show_each_row_time = true;
            cout << "   FC2 each row simulated time: " << sc_time_stamp() - fc2_each_row_start_time << endl;
        }  
    }
...
void Testbench::fc3_feed_input(){
    ...
    for (int m = 0; m != FC3_M; m++) {
        ...
        bias_sent_count++;
        fc3_each_row_start_time = sc_time_stamp(); 
    }
...
void Testbench::fc3_fetch_result(){
    ...
    for (int m = 0; m != FC3_M; m++) {
        ...
        if(has_show_each_row_time == false){
            has_show_each_row_time = true;
            cout << "   FC3 each row simulated time: " << sc_time_stamp() - fc3_each_row_start_time << endl;
        }  
    }
