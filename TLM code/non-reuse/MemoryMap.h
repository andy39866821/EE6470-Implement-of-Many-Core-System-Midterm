...
const int CONV1_MM_BASE = 0x00000000;
const int CONV1_MM_SIZE = 0x0000000C;
const int CONV1_MM_MASK = 0x0000000C;

const int CONV2_MM_BASE = 0x00000100;
const int CONV2_MM_SIZE = 0x0000000C;
const int CONV2_MM_MASK = 0x0000000C;

const int FC1_MM_BASE = 0x00000200;
const int FC1_MM_SIZE = 0x0000000C;
const int FC1_MM_MASK = 0x0000000C;

const int FC2_MM_BASE = 0x00000300;
const int FC2_MM_SIZE = 0x0000000C;
const int FC2_MM_MASK = 0x0000000C;

const int FC3_MM_BASE = 0x00000400;
const int FC3_MM_SIZE = 0x0000000F;
const int FC3_MM_MASK = 0x0000000F;
